...
type_names = [
    ("led::Matrix<led::FrameBuffer<(unsigned short)128, (unsigned short)64, led::FourPanelSnake> >", "matrix_type"),
    ("led::FrameBuffer<(unsigned short)128, (unsigned short)64, led::FourPanelSnake>", "fb_type"),
