...
namespace util {
	...
	Download download_from(const char * host, const char * path, uint32_t timeout=500);
	Download download_from(const char * host, const char * path, const char * const headers[][2], uint32_t timeout=500);
}
